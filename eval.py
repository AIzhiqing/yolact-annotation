...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45, fps_str=''):
    ...
    with timer.env('Copy'):
        idx = t[1].argsort(0, descending=True)[:args.top_k] #! 再次过滤目标
...
"""
CUDA_VISION_DEVICES=0 python eval.py --trained_model=yolact_resnet50_54_800000.pth --score_threshold=0.15 --top_k=15 --images=demo/demo_imgs:demo/result
